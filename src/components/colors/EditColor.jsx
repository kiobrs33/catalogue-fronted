...
export const EditColor = ({ show, rowData, handleClose }) => {
  const { state, handleUpdateColor } = useContext(AppContext);
  ...
  const updateColor = async (colorValue) => {
    try {
    ...
    <Modal show={show} onHide={handleHide} size="lg">
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Modal.Header closeButton>
          <Modal.Title>
            <i className="fa-solid fa-user"></i> Editar color
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
